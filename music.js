...
setInterval(() => {
  http.get(`http://musicmah.glitch.me`); //تعديل مهم حط اسم المشروع
}, 280000);
...
const GUILDID = '719604195874963538'; //  تعديل مهم ايدي السيرفر  
const CHANNELID = '725933066597433366'; // تعديل مهم ايدي الروم الصوتي
...
//تغير الحالة
const developers = ["458029748820508702","","",""] ///تعديل مهم حط هنا ايدي اللي بدك يتحكمو بالحالة
...
const youtube = new YouTube("AIzaSyD-AGglYouvBeUxIfLgp5AN5sMverDgbCo"); 
...
client.on('message', message => {
  var helplist = `**:notes:  قائمة الاوامر - Commands list** 
...
> © 2020 **__Developer__** : Mahmoud Yasser **|** <@458029748820508702>
...
**:gear: اوامر الادارة - STAFF Commands**
